...
class BracSynchronizer(QtGui.QWidget):
	...
	def capture(self):
		print 'capturing url'
		#captureurl.capture(
		#	'https://www.google.ca/search?q=game&hl=en&tbo=d&source=lnms&tbm=isch&sa=X&ei=1ycCUf3cE4PAyAHI2oCIDg&ved=0CAcQ_AUoAA&biw=1439&bih=802',
		#	'test.png',
		#	None
		#)
		...
		#print self.renderer._page.userAgentForUrl(QtCore.QUrl(url))
