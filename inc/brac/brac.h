...
#ifndef __brac_H__	// Has this not been defined yet?
#define __brac_H__	// Only include this once by predefining it
...
#include "bracTerminology.h"	// Terminology for plug-in.
#include <string>
#include <vector>
